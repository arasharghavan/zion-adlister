...
INSERT INTO categories (ad_id, year, make, model, transmission, color, fuel, price, car_condition, engine_type, mileage)
VALUES (1, 2002, 'Ford',          'F-150',            'Automatic', 'Black',  'Unleaded',   3800, 'Working',       'V6',      170000),
      ...
      (5,  2019, 'Tesla',         'Tesla',            'Automatic', 'Gold',   'Electric', 120000, 'New',           'Other',      100),
      ...
      (11, 2001, 'Subaru',        'Outback',          'Manual',    'Black',  'Unleaded',   3800, 'Working',       'v4',      270000),
      (12, 1996, 'Honda',         'Passport',         'Automatic', 'Mauve',  'Unleaded',   7800, 'Fair',          'v6',      120000),
      (13, 1979, 'International', 'Harvester',        'Automatic', 'Cyan',   'diesel',    30000, 'Good',          'v8',       10000),
      (14, 1959, 'Studebaker',    'Silver Hawk',      'N/A',       'Maroon', 'diesel',   900000, 'Great',         'v8',      125000),
      (15, 1985, 'Delorean',      'DMC',              'Automatic', 'Silver', 'regular',  120000, 'Good',          'v12',       1000);

INSERT INTO users (username, email, password)
VALUES ('Mindy', 'mjtillman@gmail.com', 'macaroni'),
